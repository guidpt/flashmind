 ...
 */
public class LastDeckRecyclerAdapter extends RecyclerView.Adapter<DeckViewHolder> {
    private final Context context;
    private List<SharedDeck> items;

    public LastDeckRecyclerAdapter(Context context, ArrayList<SharedDeck> decks) {
        this.items = decks;
    ...
    public DeckViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View v = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.recycler_last_deck, parent, false);
