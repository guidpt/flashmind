...
namespace Flashmind.Api.Token.Middleware
{
    public class TokenProviderOptions
    {
        ...
        /// </summary>
        public Func<string, string, UserRepository, Task<ClaimsIdentity>> IdentityResolver { get; set; }

        /// <summary>
        ///     Responsible for saving the token and relate it to the user
        /// </summary>
        public Func<string, string, UserRepository, Task> TokenResolver { get; set; }
